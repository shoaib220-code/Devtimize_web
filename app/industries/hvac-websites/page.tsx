...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.devtimize.com/industries/hvac-websites/',
  },
  openGraph: {
    title: 'HVAC Website Design That Fills Your Schedule | Devtimize',
    description: 'We build HVAC websites that turn searchers into booked jobs. AI chat, instant quote forms, and local SEO built in. Free audit.',
    url: 'https://www.devtimize.com/industries/hvac-websites/',
    siteName: 'Devtimize',
    locale: 'en_US',
    type: 'website',
    images: ogImage('HVAC Websites', 'That Fill Your Schedule'),
  },
};
