...
export const landingPages: LandingPageData[] = [
  {
    ...
    metaTitle: 'AI Receptionist for Dental Clinics in Kuwait | Devtimize',
    metaDescription: 'Stop losing patients to missed calls. AI receptionist for Kuwait dental clinics — answers 24/7, books appointments. Book a call for your quote.',
    ogTitle: 'AI Receptionist for Dental Clinics',
    ogSubtitle: 'Kuwait — Never Miss a Patient Call',
    kicker: 'Dental Clinics · Kuwait',
    ...
    whatItFixes: "An AI receptionist answers every call in a natural voice, books appointments straight into your calendar, and texts a confirmation — even at 11pm on a Thursday.",
  ...
  },
  {
    ...
    metaTitle: 'AI Receptionist for Law Firms in Kuwait | Devtimize',
    metaDescription: 'A missed call from a potential client often means they call the next firm. AI receptionist for Kuwait law firms — 24/7 answering and intake booking.',
    ogTitle: 'AI Receptionist for Law Firms',
    ogSubtitle: 'Kuwait — Never Miss a New Client Call',
    kicker: 'Law Firms · Kuwait',
    ...
    whatItFixes: 'Answers every call, qualifies the inquiry, and books an initial consultation directly into your calendar, day or night.',
  ...
  },
  {
    ...
    metaTitle: 'AI Receptionist for Real Estate Agencies in Kuwait | Devtimize',
    metaDescription: 'Serious buyers call at all hours. AI receptionist for Kuwait real estate agencies — answers inquiries and books viewings 24/7.',
    ogTitle: 'AI Receptionist for Real Estate',
    ogSubtitle: 'Kuwait — Never Miss a Buyer Inquiry',
    kicker: 'Real Estate · Kuwait',
    ...
    whatItFixes: 'Answers every inquiry, qualifies buyer or seller interest, and books a viewing or callback directly into your calendar.',
  ...
  },
  {
    ...
    metaTitle: 'AI Receptionist for Dental Clinics in the UK | Devtimize',
    metaDescription: 'Missed calls mean lost patients. AI receptionist for UK dental clinics — 24/7 answering, appointment booking, no long-term contract.',
    ogTitle: 'AI Receptionist for Dental Clinics',
    ogSubtitle: 'UK — Never Miss a Patient Call',
    kicker: 'Dental Clinics · UK',
    h1: 'Every Missed Call Is a Patient Booked Elsewhere',
    ...
    whatItFixes: 'Answers calls around the clock, books appointments straight into your calendar, and sends confirmations automatically.',
  ...
  },
  {
    ...
    metaTitle: 'AI Receptionist for Law Firms in the UK | Devtimize',
    metaDescription: 'A missed intake call often becomes a competitor\'s client. AI receptionist for UK law firms — 24/7 intake answering and consultation booking.',
    ogTitle: 'AI Receptionist for Law Firms',
    ogSubtitle: 'UK — Never Miss a New Client Call',
    kicker: 'Law Firms · UK',
    h1: 'A Missed Call Is a Client Calling Your Competitor',
    painParagraph: "A prospective client who can't reach your firm rarely waits — they call the next one.",
    whatItFixes: 'Answers every call, qualifies the inquiry, books an initial consultation, and flags urgent matters immediately.',
