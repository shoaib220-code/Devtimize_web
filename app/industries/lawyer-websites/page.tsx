...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.devtimize.com/industries/lawyer-websites/',
  },
  openGraph: {
    title: 'Law Firm Website Design That Generates Cases | Devtimize',
    description: 'We build law firm websites that rank on Google, build authority, and convert visitors into consultation bookings. Trusted by firms in US and UK.',
    url: 'https://www.devtimize.com/industries/lawyer-websites/',
    siteName: 'Devtimize',
    locale: 'en_US',
    type: 'website',
    images: ogImage('Law Firm Websites', 'That Generate Cases'),
  },
};
