...
export const services: Service[] = [
  {
    ...
    longDesc: 'We specialize in building production-grade web applications that are fast, secure, and scalable. Our approach combines cutting-edge frontend technologies with robust backend architectures to deliver seamless user experiences. We work with clinics, law firms, and small businesses in the United States, United Kingdom, Canada, Europe, Australia, and Kuwait.',
  ...
  },
  {
    ...
    longDesc: 'We bring intelligence to your business. From custom LLM implementations to automated trading systems, we leverage the latest in AI to automate complex tasks and provide data-driven insights. Our AI receptionist product is built for local businesses in the UK, Kuwait, and beyond that want to handle calls and bookings around the clock.',
